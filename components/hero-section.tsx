                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0 relative">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        href="https://github.com/hasin-codes/sweesh.exe/releases/download/v1.3.9/Sweesh-Setup-1.3.9.exe"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.3.9/Sweesh-Setup-1.3.9.exe', '_blank');
                                        }}
                                        ...
                                        <div className="bg-background group-hover:bg-muted size-6 overflow-hidden rounded-full duration-500">
                                            <div className="flex w-12 -translate-x-1/2 duration-500 ease-in-out group-hover:translate-x-0">
                                                <span className="flex size-6">
                                                    <ArrowDown className="m-auto size-3" />
                                                </span>
                                                <span className="flex size-6">
                                                    <ArrowDown className="m-auto size-3" />
                                                </span>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            onClick={() => window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.3.9/Sweesh-Setup-1.3.9.exe', '_blank')}>
