                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0 relative">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        href="https://github.com/hasin-codes/sweesh.exe/releases/download/v1.4.0/Sweesh-Setup-1.4.0.exe"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.4.0/Sweesh-Setup-1.4.0.exe', '_blank');
                                        }}
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            onClick={() => window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.4.0/Sweesh-Setup-1.4.0.exe', '_blank')}>
