                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0 relative">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        href="https://github.com/hasin-codes/sweesh.exe/releases/download/v1.0.9/Sweesh_Setup_1.0.9.exe"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.0.9/Sweesh_Setup_1.0.9.exe', '_blank');
                                        }}
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            onClick={() => window.open('https://github.com/hasin-codes/sweesh.exe/releases/download/v1.0.9/Sweesh_Setup_1.0.9.exe', '_blank')}>
